...
export const RawItemsWithFakePower = [...RawItems];
// For consistency with old versions, FakePower is always at index 116
RawItemsWithFakePower.splice(116, 0, FakePower);
